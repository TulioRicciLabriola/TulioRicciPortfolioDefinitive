      ...
      <div className="max-w-6xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          ...
          <a href="https://www.linkedin.com/in/tulio-ricci-labriola/" target="_blank" rel="noopener noreferrer" className="group flex items-center justify-between p-8 border border-black/10 hover:bg-black hover:text-white transition-all duration-300">
            ...
            <div className="flex items-center gap-4"><svg className="w-8 h-8 transition-transform group-hover:scale-110" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0-2.761 2.239-5 5-5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg></div>
          </a>
        </div>
        <div className="flex flex-col md:flex-row justify-between items-center pt-12 border-t border-black/10 gap-6">
          <div className="flex items-center gap-3">
             <div className="w-10 h-10 bg-black flex items-center justify-center"><span className="text-white font-bold heading-font italic">TR</span></div>
             <span className="font-bold text-sm tracking-widest uppercase">Tulio Ricci Portfolio</span>
          </div>
          <p className="text-[10px] uppercase tracking-[0.2em] text-gray-500 font-bold">{t.contact.footerRights}</p>
        </div>
      </div>
    </section>
  );
